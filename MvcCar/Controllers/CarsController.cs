...
namespace MvcCar.Controllers
{
    public class CarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Color,Speed,Transmission")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Color,Speed,Transmission")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
